"""
Django settings for queroestudar project.
...
ROOT_URLCONF = 'queroestudar.urls'
...
WSGI_APPLICATION = 'queroestudar.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DJANGO_DB_USER', 'adminquero'),
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './queroestudar.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
